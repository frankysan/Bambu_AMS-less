;=== Bambu Lab A1 Filament change Annotated G-code ===
...
M620 S[next_extruder]A
    ...
    G1 X267 F18000 ; Move the nozzle to the right, near the AMS area for filament removal.

    M620.1 E F[old_filament_e_feedrate] T{nozzle_temperature_range_high[previous_extruder]} ; Command AMS to pull out the old filament.
...
M621 S[next_extruder]A ; Reactivate AMS if used.
